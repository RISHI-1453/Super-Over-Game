...
function playSuperOver() {
    ...
    if(buttonValue.getAttribute("value") == "GO!!") {
        ...
        if(startSecond == false) {
            if(chosenTeam == "RCB") {
                ...
                if(team1Prog.length == 6 || wickCount1 == 2 ) {
                    console.log("Stop");
                    startSecond = true;
                    buttonValue.setAttribute("value", "GO!!");
                ...
                if(team2Prog.length == 6 || wickCount2 == 1) {
                    console.log("Stop");
                    buttonValue.setAttribute("value", "GO!!");
                    console.log(buttonValue.getAttribute("play"));
                    startSecond = true;
                }
        ...
        if(startSecond == true) {
            ...
            resultText.textContent = "2nd Innings";
        ...
        if(nextTeam == "RCB") {
            ...
            if(team1Prog.length == 6 || wickCount1 == 2 || team1Run >= team2Run ) {
                console.log("Stop");
                resultText.textContent = "RCB Wins the 5 times IPL champion";
